...
function Description(props) {
    return (
        <section className="max-sm:px-0 max-xl:px-14 bg-gray-100 dark:bg-gray-900">
            <div className='max-sm:px-1 px-20 mx-auto max-w-screen-xl text-center py-24 lg:py-15 sm:py-15'>
