        ...
        <footer className="bg-green-950 dark:bg-gray-800">
            <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                    <div>
                        <a href="/accueil" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                ...
                <hr className="my-6 border-white sm:mx-auto dark:border-white lg:my-8" />
                    <div className="text-center">
                        ...
                        <ul className="flex justify-center mt-5 space-x-5">
                            <li>
                                <a href="#" className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
